...
public class ElderGuardianRaidAxe extends SwordItem implements ConfigurableAttributes {
    ...
    public ElderGuardianRaidAxe(ToolMaterial material, Settings settings) {
        this(material, 1, 2.4F, settings);
    }

    public ElderGuardianRaidAxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
